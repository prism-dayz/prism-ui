...
const EXPERIMENTAL_SERVER_ID = '5370029'
...
const doNitradoFileServerApi = (method, url, token, file, resolve, reject) => {
  const options = {
    'method': method,
    'url': url,
    'headers': {
...
const doNitradoFileServerApiProper = (method, url, token, resolve, reject) => {
...
const doNitradoApi = (method, path, resolve, reject, authBearer) => {
  const options = {
    'method': method,
...
const doNitradoFileServer = (method, path, resolve, reject) => {
  const options = {
    'method': method,
    'url': path
  }
...
const getGameserver = (service, authBearer) => new Promise((resolve, reject) => {
...
const getWsConnection = (service) => new Promise((resolve, reject) => {
...
const reinstallServer = (service) => new Promise((resolve, reject) => {
  const method = 'POST'
...
const serverOnline = (serverId) => new Promise((resolve, reject) => {

})

const getServerFileList = (service) => new Promise((resolve, reject) => {
  // /file_server/list  
  const method = 'GET'
